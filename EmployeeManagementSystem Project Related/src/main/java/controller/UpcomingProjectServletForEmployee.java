...
/**
 * Servlet implementation class UpcomingProjectServletForEmployee
 */
public class UpcomingProjectServletForEmployee extends HttpServlet {
     ...
     */
    public UpcomingProjectServletForEmployee() {
        super();
