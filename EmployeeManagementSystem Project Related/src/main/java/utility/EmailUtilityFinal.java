...
public class EmailUtilityFinal  {
  ...
  private static final String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
   ...
   public static void sendMail(EmailMessageDTO emailMessageDTO) throws ApplicationException{
	   
     final String sender_Email = "mansij.inexture@gmail.com";
     final String sender_email_pass = "Mansi@2k22?@!";
       try {
           ...
           case EmailMessageDTO.HTML_MSG:
               msg.setContent(emailMessageDTO.getMessage(), "text/html");
               break;
           case EmailMessageDTO.TEXT_MSG:
