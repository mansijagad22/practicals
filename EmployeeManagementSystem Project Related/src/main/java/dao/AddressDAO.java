		...
		public Boolean updateAddressByAddIdAndEmpId(Address a) {
			...
			try {
				ps = con.prepareStatement(
						"UPDATE employee SET street= ?,city=?,state=?,pin_code=?where emp_id=?, address_id=?");
				ps.setString(1,a.getStreet().toString());
				ps.setString(2,a.getCity().toString());
				ps.setString(3,a.getState().toString());
				ps.setString(4, a.getPinCode().toString());
